  ...
  return (
    <>
      ...
      <div className="hidden lg:block relative">
        ...
        >
          <div
            className="absolute left-0 right-0 h-px bg-gray-400/30 z-20 hidden lg:block"
            style={{ top: "50.5%" }}
          />
          ...
          <GridContainer className="items-center h-full pt-20">
            <GridCol span="AB" className="pl-12 pr-8 pb-8">
              ...
              <div className="space-y-6 relative">
                <div
                  className="absolute text-(--brand-red) font-light z-30"
                  style={{
                    left: "-7.65%",
                    top: "-26%",
                    fontSize: "2.5rem",
            ...
            <div
              className="absolute text-(--brand-black) font-light z-30"
              style={{
                left: "50%",
                top: "calc(50.5% - 3px)",
