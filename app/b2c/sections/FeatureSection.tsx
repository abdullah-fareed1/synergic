  ...
  return (
    <>
      <GridSection 
        ...
        className="relative"
      >
        <div className="hidden lg:block absolute inset-y-0 left-0 w-[5.56%]">
          <StripedBackground />
        </div>
        <div className="hidden lg:block absolute inset-y-0 right-0 w-[5.56%]">
          <StripedBackground />
        </div>
      ...
      <section className="lg:hidden w-full bg-[#F3F5F5] px-5 py-10">
        <h2 className="text-3xl font-extrabold text-black mb-3 ">
          Made to Match the Way<br/>You Sell
        </h2>
        
        <p className="text-[15px] text-black  mb-6">
          No two businesses sell the same way. That's why no single<br/> platform works for all. We build commerce systems around<br/> <span className="font-semibold">how you operate:</span>
        </p>
        
        <div className="flex items-center gap-2 mb-8">
          <div className="w-13 h-13 bg-[#8044DE] rounded-lg flex items-center justify-center">
            <img src="icons/pc-and-smartphone.svg" alt="PC and Smartphone" className="w-7 h-7" />
          </div>
          <div className="w-13 h-13 bg-[#8044DE] rounded-lg flex items-center justify-center">
            <img src="icons/server.svg" alt="Server" className="w-7 h-7" />
          </div>
          <div className="w-13 h-13 bg-[#8044DE] rounded-lg flex items-center justify-center">
            <img src="icons/cloud-network3.svg" alt="Cloud Network" className="w-7 h-7" />
          </div>
          <div className="w-13 h-13 bg-[#8044DE] rounded-lg flex items-center justify-center">
            <img src="icons/shield-check.svg" alt="Shield Check" className="w-7 h-7" />
          </div>
        </div>

        <ul className="space-y-3 pb-12 ">
          <li className="flex items-center gap-2.5">
            <span className="w-2 h-2 rounded-full bg-[#8044DE] shrink-0"></span>
            <span className="text-black text-[15px] leading-normal">Launch a fast, mobile-first eShop</span>
          </li>
          <li className="flex items-center gap-2.5">
            <span className="w-2 h-2 rounded-full bg-[#8044DE] shrink-0"></span>
            <span className="text-black text-[15px] leading-normal">Scale to B2B or hybrid models</span>
          </li>
          <li className="flex items-center gap-2.5">
            <span className="w-2 h-2 rounded-full bg-[#8044DE] shrink-0"></span>
            <span className="text-black text-[15px] leading-normal">Manage thousands of SKUs with ease</span>
          </li>
          <li className="flex items-center gap-2.5">
            <span className="w-2 h-2 rounded-full bg-[#8044DE] shrink-0"></span>
            <span className="text-black text-[15px] leading-normal">Integrate ERP, CRM, or logistics providers</span>
          </li>
          <li className="flex items-center gap-2.5">
            <span className="w-2 h-2 rounded-full bg-[#8044DE] shrink-0"></span>
            <span className="text-black text-[15px] leading-normal">Expand with portals, mobile apps, or automations</span>
          </li>
        </ul>
      </section>
    </>
