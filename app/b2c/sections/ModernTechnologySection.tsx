  ...
  return (
    <>
      ...
      <GridSection 
        ...
        bgColor="bg-[#F3F5F5]"
      >
        {/* Horizontal line at 7% from top - Desktop only */}
        <div className="hidden lg:block absolute left-0 right-0 h-px bg-gray-400 opacity-30 z-2" style={{ top: '7%' }} />
        
        {/* Diagonal stripes - top left corner - Desktop only */}
        <div
          ...
          <GridCol span="AB" className="pr-12 py-8 pt-15 pl-9">
            <div className="space-y-8">
              ...
              <p className="text-gray-600 text-2xl ">
                At the core of every project is our Composable Technology<br/> Pack — built to adapt, scale, and integrate.
              </p>
      ...
      <section className="lg:hidden bg-[#F3F3EE] px-6 py-12">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-l leading-relaxed">
              At the core of every project is our Composable Technology Pack — built to adapt, scale, and integrate.
            </p>
          </div>
