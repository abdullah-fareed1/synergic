  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-20">
      ...
      <div className="relative flex items-start justify-between" style={{ height: 'calc(100vw / 20)' }}>
        ...
        <div 
          className="hidden lg:flex items-center justify-end absolute top-0 bottom-0 pr-4 gap-3 cursor-pointer hover:opacity-80 transition bg-black/20"
          style={{ 
            right: '5.56%',
            width: 'calc(5.56% * 2)'
          }}
        ...
        >
          <div className="flex flex-col items-center gap-1">
            <div className="flex flex-col gap-1">
              <div className="bg-black w-10 h-0.75 rounded-sm" />
              <div className="bg-black w-10 h-0.75 rounded-sm" />
            </div>
            <span
