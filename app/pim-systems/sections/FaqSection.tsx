...
const faqData = [
  ...
  {
    question: "Will my suppliers need to change their formats?",
    answer:
      "No, our system adapts to your suppliers' existing formats. We handle the data transformation automatically, so your suppliers can continue using their current processes.",
  },
  {
    question: "What about our existing product data?",
    answer:
      "We seamlessly integrate with your existing product data. Our migration tools ensure a smooth transition without any data loss or disruption to your operations.",
  },
  {
    question: "Will my team need technical expertise to manage it?",
    answer:
      "No technical expertise required. Our intuitive interface is designed for business users, with comprehensive support and training available when needed.",
  },
];
