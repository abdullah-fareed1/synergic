    ...
    <>
      <section className="lg:hidden relative bg-(--brand-light) overflow-hidden">
        ...
        <div className="px-6 pb-8" style={{ paddingTop: "100px" }}>
          ...
          <p className="text-[18px] text-(--brand-black) mb-4 leading-snug font-medium">
            ...
            <GridContainer className="items-center">
              <GridCol span="AB" className="pl-12 pr-8">
                <div style={{ paddingTop: "calc(100vw / 18 + 20px)" }}>
                  <h1 className="text-[42px] font-extrabold text-[#111D2B] mb-3 leading-[1.1] max-w-xl">
                    Take Control of Your Product Data
                  </h1>
                  <p className="text-[22px] text-[#111D2B] mb-6 leading-snug max-w-lg font-medium">
                    Centralized Product Management Across Suppliers and Channels
                  </p>
